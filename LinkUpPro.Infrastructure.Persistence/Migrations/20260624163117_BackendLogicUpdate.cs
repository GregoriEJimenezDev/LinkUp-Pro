...
{
    /// <inheritdoc />
    public partial class BackendLogicUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAttackedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CurrentTurnPlayerId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttackedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    GameId = table.Column<int>(type: "integer", nullable: false),
                    AttackerId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSunk = table.Column<bool>(type: "boolean", nullable: false),
                    GameId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Row = table.Column<int>(type: "integer", nullable: false),
                    Column = table.Column<int>(type: "integer", nullable: false),
                    WasAttacked = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attacks_GameId_AttackerId_Row_Column",
                table: "Attacks",
                columns: new[] { "GameId", "AttackerId", "Row", "Column" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipCells_ShipId_Row_Column",
                table: "ShipCells",
                columns: new[] { "ShipId", "Row", "Column" },
                unique: true);
